...
def predict():
    ...
    for i in range(0, len(testdataset)):
        ...
        if y_pred[i]==0:
             finalstr = str(finalstr + testdataset['Incident'][i] + '=======> Application#')
        elif y_pred[i]==1:
             finalstr = str(finalstr + testdataset['Incident'][i] + '=======> Payment#')
        elif y_pred[i]==2:
             finalstr = str(finalstr + testdataset['Incident'][i] + '=======> Cofc#')
        elif y_pred[i]==3:
             finalstr = str(finalstr + testdataset['Incident'][i] + '=======> Perf Cal#')
        elif y_pred[i]==4:
             finalstr = str(finalstr + testdataset['Incident'][i] + '=======> Bancs#')
        elif y_pred[i]==5:
             finalstr = str(finalstr + testdataset['Incident'][i] + '=======> Arrears#')
        else:
             finalstr = str(finalstr + testdataset['Incident'][i] + '=======> Enforcement#')
